...
<html lang="en">
  ...
  <title>swiper/swiper.min.js at master · nolimits4web/swiper</title>
    <meta name="description" content="Most modern mobile touch slider with hardware accelerated transitions">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6Mjk3ODAyMTUyOmNkZWE0OWEwMDRlNTQxNDJjOWZmNGExMWYzYjgwMTJiNTJlMDcwZjE1NGE2M2M3ZjM2ZTgwZDhjNGY3ZDUwMjQ=--7b9559e8cabcfafaaab3356a6ad0f6e019beb223">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="3C3B:5D16:6827A:9E8B1:5B7D1796" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="3C3B:5D16:6827A:9E8B1:5B7D1796" /><meta name="octolytics-dimension-region_edge" content="sea" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="7077652" /><meta name="octolytics-actor-login" content="ChoiByungNam" /><meta name="octolytics-actor-hash" content="2530be1318c8443f8c085ad2585b2031c7f368161d5aea71b642f176b3549f60" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />



  <meta class="js-ga-set" name="userId" content="60a899e128c2ca549e47e8d60b47643d" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="ChoiByungNam">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="MTdjYzBjODQxNjE5Y2EyYzYwOTQzNWM4NjNiZDMxMzNlMDhiODMwOGZkODI4YWY3OTNlNTU5MDk4YmRmZTZkZXx7InJlbW90ZV9hZGRyZXNzIjoiMTEyLjE2OS42NC4yMyIsInJlcXVlc3RfaWQiOiIzQzNCOjVEMTY6NjgyN0E6OUU4QjE6NUI3RDE3OTYiLCJ0aW1lc3RhbXAiOjE1MzQ5MjQ2OTQsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="c31e05df853b309aff5605032079e16206480d99">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="3721224" data-scoped-search-url="/nolimits4web/swiper/search" data-unscoped-search-url="/search" action="/nolimits4web/swiper/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=mII7MiTcypjLfZ0Ay365iNUfJ7OQNUoTP+o8C4RG8fpF6Iq3MDwNkeP41wUrDzfn4b7sm+zOJCBKTxUuhyP7fA=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:7077652" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@ChoiByungNam" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/7077652?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/ChoiByungNam" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">ChoiByungNam</strong></a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/ChoiByungNam" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/ChoiByungNam?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/ChoiByungNam?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="uXbAsowrmY4nda7Gwtd+33PzECIJOYMap3GQHAUYhbI1Y7ldZYAQmPT19ohu2mrVCFiWRr+MGvu/nKN57tL5qw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="1r/AeItuoVXtiPYNTxxn89VYCMxUWpAUZJvCQdJsU61aqrmXYsUoQz4IrkPjEXP5rvOOqOLvCfV8dvEkOaYvtA==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="wTuip8v6kptY0QW2MmTd2Mk1ZyHGcocbduckGwzL+gG3J5yGLW4eFpI8jXmKFhCUOSpsu/F9CJc+bJP2l/N5Ng==" />      <input type="hidden" name="repository_id" id="repository_id" value="3721224" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/nolimits4web/swiper/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="TNEeAlJguJDgzf8DXSkbzF3Oa6MgUNsWJF8j3Sw11oezCXqvrUU0K46UF/Uz8LDOT5NMZrC4idFGj6dXA5zpAA==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/nolimits4web/swiper/stargazers"
           aria-label="17297 users starred this repository">
          17,297
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/nolimits4web/swiper/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="GXbLFEXwsNqVaC7/wZNcLA5lJwQrxEZkkfjn4r1og3K16TmmpgFNOejtkaam84frcLiGzXZV0VYOk8gGQM/umw==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
    ...
    <a href="/nolimits4web/swiper/network/members" class="social-count"
       aria-label="6138 users forked this repository">
      6,138
    </a>
  </li>
</ul>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/nolimits4web/swiper/blob/a9bdb791535cde48542c6b3cedf9603082d8a2bf/dist/js/swiper.min.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:d4594372dbc11dc1b10e24c342253ce8 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/nolimits4web/swiper/blob/greenkeeper/eslint-5.0.0/dist/js/swiper.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/nolimits4web/swiper/blob/greenkeeper/eslint-5.0.1/dist/js/swiper.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/nolimits4web/swiper/blob/greenkeeper/rollup-0.64.0/dist/js/swiper.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/nolimits4web/swiper/blob/greenkeeper/rollup-0.64.1/dist/js/swiper.min.js"
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/nolimits4web/swiper/commit/6f9f8e70734618c87e3f456ad21549c9ed253499" data-pjax>
          6f9f8e7
        </a>
        <relative-time datetime="2018-07-31T12:43:09Z">Jul 31, 2018</relative-time>
      </span>
      <div>
        ...
        <a class="user-mention" rel="author" data-hovercard-user-id="999588" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/nolimits4web">nolimits4web</a>
          <a data-pjax="true" title="4.3.5 Release" class="message" href="/nolimits4web/swiper/commit/6f9f8e70734618c87e3f456ad21549c9ed253499">4.3.5 Release</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"> * Swiper 4.3.5</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line"> * Released on: July 31, 2018</td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/nolimits4web/swiper/blame/a9bdb791535cde48542c6b3cedf9603082d8a2bf/dist/js/swiper.min.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.34074s from unicorn-926079661-4rd44">GitHub</span>, Inc.</li>
